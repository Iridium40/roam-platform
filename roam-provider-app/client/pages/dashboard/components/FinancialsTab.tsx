                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          <p className="text-sm">
                            Payouts are sent on a weekly schedule by default and include all completed transactions from the previous period. 
                            You can customize your payout schedule in Stripe.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
