-- Migration: Add pricing_type to provider_bookings_enriched view
-- Purpose: Include service pricing_type so provider app can determine 
-- whether to show final balance modal when completing deposit services
...
SELECT 
  ...
  s.pricing_type AS service_pricing_type,  -- NEW: for deposit vs fixed price detection
...
Includes payment tracking fields and service_pricing_type for deposit service detection.';
