      ...
      try {
        ...
        window.google.accounts.id.initialize({
          ...
          callback: async (response: CredentialResponse) => {
            try {
              logger.debug("Google One Tap callback received");
              ...
              if (signInWithGoogleIdToken) {
                ...
                logger.debug("Successfully signed in with Google One Tap");
              }

              onSuccess?.();
            } catch (error) {
              logger.error("Error signing in with Google One Tap:", error);
              onError?.(error);
            }
          },
          nonce: hashedNonce,
        ...
        window.google.accounts.id.prompt((notification) => {
          if (notification.isNotDisplayed()) {
            ...
            logger.debug("Google One Tap not displayed:", reason);
